...
describe Cd do
  ...
  it "should not create a new instance given two equals attributes of serial number" do
    cd1 = Cd.create({:model => 'Lite-On', :serialnumber => '1234567890', :mark_id => 1  })
    cd2 = Cd.create({:model => 'Dell', :serialnumber => '1234567890', :mark_id => 1  })
