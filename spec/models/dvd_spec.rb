...
describe Dvd do
  ...
  it "should not create a new instance given two equals attributes of serial number" do
    dvd1 = Dvd.create({:model => 'Lite-On', :serialnumber => '1234567890' })
    dvd2 = Dvd.create({:model => 'Dell', :serialnumber => '1234567890' })
